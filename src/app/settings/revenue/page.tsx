...
/* ── Transactions data ───────────────────────────────────────── */
const transactions = [
  { id: 'TXN-884291', orderId: '#CO-9921', customer: 'Eleanor Pena', amount: 'RM 128.50', status: 'SUCCESS' as const },
  { id: 'TXN-884292', orderId: '#CO-9925', customer: 'Bessie Cooper', amount: 'RM 42.00', status: 'FAILED' as const },
  { id: 'TXN-884293', orderId: '#CO-9928', customer: 'Floyd Miles', amount: 'RM 75.20', status: 'PENDING' as const },
  { id: 'TXN-884294', orderId: '#CO-9930', customer: 'Jane Cooper', amount: 'RM 210.00', status: 'SUCCESS' as const },
];
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh', overflow: 'hidden' }}>
        ...
        <main style={{ flex: 1, padding: '28px 32px 40px', overflowY: 'auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '24px' }}>
            {[
              { label: 'TOTAL COMMISSION EARNED', value: 'RM 42,180.00', icon: 'commission' },
              { label: 'TOTAL REVENUE', value: 'RM 482,950.00', trend: '+12.4%', icon: 'revenue' },
              { label: 'AVG. COMMISSION/ORDER', value: 'RM 12.45', icon: 'avg' },
            ].map((s) => (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '32px' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {[
                    { label: 'Base Fare', value: 'RM 85.00', color: '#0F172A' },
                    { label: 'Distance (12 km)', value: 'RM 24.00', color: '#0F172A' },
                    { label: 'Surge Pricing', value: 'RM 19.50', color: '#0F172A' },
                    { label: 'Platform Comm. (15%)', value: '-RM 19.28', color: '#DC2626' },
                  ].map((row) => (
                  ...
                  <div style={{ borderTop: '1px solid #F1F5F9', paddingTop: '12px', marginTop: '4px', display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 700, color: '#2563EB' }}>RM 109.22</span>
                  </div>
                </div>
              </div>
